...
class Limage
{
    ...
    private function get_img_info($source)
    {
        ...
        if (function_exists('read_exif_data') && in_array($ext, array(
            'jpg',
            'jpeg',
            'jpe',
            'jfif'
